...
/*
* $Id: ym_hsbc.php 2418 2012-11-27 10:35:23Z bcarlyon $
* $Revision: 2418 $
* $Date: 2012-11-27 10:35:23 +0000 (Tue, 27 Nov 2012) $
*/

class ym_hsbc extends ym_payment_gateway {
	var $name = '';
	var $code = 'ym_hsbc';

	function __construct() {
		$this->version = '$Revision: 2418 $';
		$this->name = __('Make Payments with HSBC', 'ym');
		$this->description = __('HSBC Provides a CardHolder Payment Interface (CPI) for Secure ePayments', 'ym');
		...
		$this->action_url = 'https://www.cpi.hsbc.com/servlet';
...
//		echo '<p>' . $data['status_str'] . '</p>';
	...
	function generateHash($vector, $s) {
		...
		$orderCrypto = new ym_hsbc_HSBCorderCrypto();
